      ...
      <div className="absolute lg:right-20 bg-[#1c1c1cea] p-8 rounded-[24px] shadow-md z-10 w-[360px] h-[454px] md:w-[464px] flex flex-col">
        <form onSubmit={handleSubmit} className="w-full flex flex-col flex-grow">
          ...
          <div className="mt-auto mb-1">
            <button type="submit" className="bg-[rgba(193,239,0,1)] text-black rounded-[12px] h-[54px] w-full px-4 py-3 text-lg font-normal leading-none text-center flex items-center justify-center">
              Зарегистрироваться
            </button>
          </div>
        </form>
...
//   const { login, password, setLogin, setPassword, handleSubmit: rawSubmit } = useAuth();
//   const handleSubmit = async (e: React.FormEvent) => {
//     e.preventDefault();
  
//     console.log("Форма отправлена");
  
//     const success = await rawSubmit(); // Убедись, что rawSubmit() возвращает true/false
  
//     if (success) {
//       const redirectTo = localStorage.getItem("redirectAfterLogin") || "/catalog";
//       localStorage.removeItem("redirectAfterLogin");
//       console.log("Редирект на: ", redirectTo); // Логируем путь
...
//           </div>
//           <div className="mt-auto mb-1">
//             <UniversalButton text="Зарегистрироваться" />
//             {/* Убираем href, теперь кнопка просто вызывает submit */}
//           </div>
//         </form>
//       </div>
//     </div>
